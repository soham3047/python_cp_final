...
def create_plot():
    ...
    ax1.annotate('Age > 65 Threshold Drop', xy=(66, 4.5), xytext=(40, 3.8), arrowprops=dict(facecolor='black', shrink=0.05, width=1, headwidth=6))
    ax1.annotate('Age > 75 Threshold Drop', xy=(76, 4.0), xytext=(50, 2.8), arrowprops=dict(facecolor='black', shrink=0.05, width=1, headwidth=6))
    genetic_scenarios = [
        "Baseline\n(No Mutations)",
    ...
    genetic_doses = [
        calculate_dosage(50, 70, "0/0", "0/0", "0/0"),
        calculate_dosage(50, 70, "0/0", "0/1", "0/0"),
        calculate_dosage(50, 70, "0/1", "0/0", "0/0"),
        calculate_dosage(50, 70, "1/1", "0/0", "0/0")
    ]
